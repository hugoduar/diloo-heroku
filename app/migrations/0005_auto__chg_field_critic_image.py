...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dilooapp_critic', 'image', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Critic.image'
        db.alter_column(u'dilooapp_critic', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
