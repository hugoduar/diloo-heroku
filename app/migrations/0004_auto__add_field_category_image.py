...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'dilooapp_category', 'image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'dilooapp_category', 'image')
    ...
    models = {
        ...
        u'dilooapp.critic': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "'media/images/profile/no-img.jpg'", 'max_length': '100'}),
